// Part D — Pure puzzle-content contract helpers (no I/O), ported verbatim from
// scripts/far287/lib/puzzle-schema.mjs so the deployed worker and the local
// FAR-287 script share one contract. Schemas are from docs/puzzle-schemas.md
