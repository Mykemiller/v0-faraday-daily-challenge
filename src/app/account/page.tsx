        ...
        <Card className={optedOut ? "" : "border-red-200"}>
          ...
          {optedOut ? (
            <>
              ...
              <p className="mb-4 font-mono text-[12px] text-near-black/50">Your Intelligence Readiness and history are kept. Rejoin anytime.</p>
            ...
            <>
              <p className="mb-4 font-mono text-[12px] text-near-black/50">
                Leaving pauses your Intelligence Readiness and hides you from leaderboards. <strong className="text-near-black">Nothing is deleted.</strong>
              </p>
